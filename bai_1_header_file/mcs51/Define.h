...
#define BIT_TMP 		F0	// bit F0 lives in the PSW register
#define EA_SAVE			F0
...
//8 x 4 --> 32
#define MAKELONG(v1,v2,v3,v4)   (((uint32_t)(v1)<<24)+((uint32_t)(v2)<<16)+((uint32_t)(v3)<<8)+(uint32_t)(v4))  //v1,v2,v3,v4 is uint8_t
//32 --> 16 x 2
